            ...
            <tr>
                <td class="style1" colspan="4">
                    <asp:GridView ID="GridView1" runat="server" Width="100%" AllowPaging="True" 
                        ...
                        <Columns>
                        <asp:BoundField DataField="userid" HeaderText="用户编号"><ItemStyle Width="40%" /></asp:BoundField>
                        <asp:BoundField DataField="username" HeaderText="用户姓名"><ItemStyle Width="40%" /></asp:BoundField>
                 </Columns>
                    </asp:GridView>
                </td>
            </tr>
